...
#import "TempLeftPopupViewController.h"

@implementation TempLeftPopupViewController
@synthesize TempLeftImage;
...
- (void)kegWebRequestComplete:(NSData *)responseData {
    ...
    self.TempLeftImage.image = [UIImage imageWithData:responseData];
}
